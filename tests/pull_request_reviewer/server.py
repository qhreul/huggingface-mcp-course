...
try:
    from huggingface_mcp_course.pull_request_reviewer.server import (
        mcp,
...
class TestImplementation:
    ...
    def test_imports(self):
        ...
        assert callable(suggest_pr_template), "suggest_template should be a callable function"
...
class TestSuggestTemplate:
    ...
    async def test_returns_json_string(self):
        ...
        result = await suggest_pr_template(
    ...
    async def test_returns_error(self):
        ...
        assert suggestion["error"]["message"] == "Not Pull Request template were found for error", \
            f'Expected message = "", but got {suggestion["error"]["message"]}'
...
class TestToolRegistration:
    ...
    def test_tools_have_decorators(self):
        ...
        assert hasattr(suggest_pr_template, '__name__'), \
            "suggest_pr_template should be a proper function"
